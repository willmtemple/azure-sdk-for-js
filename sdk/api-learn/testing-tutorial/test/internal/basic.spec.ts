// Chai is the Azure SDK Team's preferred assertion library, and it is
// included as part of our template project.
import { assert } from "chai";

// Import the internal function to be tested using the normal relative
// import syntax.
import { quoteETag } from "../../src/util";

// Unit tests SHOULD appear inside of a `describe` block.
// The hierarchical oranization of tests within `describe` blocks will be
// reflected in our pipeline analytics and metrics.
