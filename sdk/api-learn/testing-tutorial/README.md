...
### Install the `@azure/testing-tutorial` package

Install the Example client library for JavaScript with `npm`:

```bash
npm install @azure/testing-tutorial
```
...
[samples](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/learn/testing-tutorial/samples)
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js%2Fsdk%2Flearn%2Ftesting-tutorial%2FREADME.png)
